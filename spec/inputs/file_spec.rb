...
require "logstash/inputs/file_extended"
require "tempfile"
...
describe LogStash::Inputs::FileExtended do
  describe "testing with input(conf) do |pipeline, queue|" do
    ...
    context "when sincedb_path is an existing directory" do
      ...
      subject { LogStash::Inputs::FileExtended.new("path" => tmpfile_path, "sincedb_path" => sincedb_path) }
    ...
    context "when data exists and then more data is appended" do
      ...
      before do
        ...
        conf.update("type" => "blah",
                    ...
                    "codec" => mlcodec,
                    "delimiter" => FILE_DELIMITER,
                    "auth_endpoint" => "http://localhost:9090/microservice/MD5validate")
        subject.register
      end
